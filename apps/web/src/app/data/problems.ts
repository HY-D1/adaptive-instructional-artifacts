...
INSERT INTO orders VALUES (103, 2, 'Keyboard', 79.99);`,
  ...
  },
  {
    ...
    description: 'Count how many orders each user has placed. Show user name and order count (as order_count).',
    difficulty: 'intermediate',
    concepts: ['joins', 'aggregation'],
    topic: 'aggregation',
    topicDifficultyLevel: 3,
    schema: `CREATE TABLE users (
  id INTEGER PRIMARY KEY,
  name TEXT
);
...
INSERT INTO orders VALUES (103, 2, 'Keyboard');`,
  ...
  },
  {
    ...
    description: 'Calculate the average price (as avg_price) for each product category.',
    difficulty: 'intermediate',
...
INSERT INTO products VALUES (4, 'Chair', 'Furniture', 199.99);`,
  ...
  },
  {
    ...
    description: 'Show user_id and order count (as order_count) for users with two or more orders.',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    description: 'Show category and average price (as avg_price) for categories whose average product price is over 200.',
    difficulty: 'intermediate',
    concepts: ['aggregation'],
    topic: 'aggregation',
    topicDifficultyLevel: 2,
  ...
  },
  {
    ...
    description: 'Find categories with their product count (as product_count) that contain at least two products.',
    difficulty: 'intermediate',
    concepts: ['aggregation'],
    topic: 'aggregation',
    topicDifficultyLevel: 2,
  ...
  },
  {
    ...
    description: 'Find the top 2 highest paid employees in each department using ROW_NUMBER (as rn).',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    description: 'Rank all employees by salary (highest first) using RANK() (as salary_rank).',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    description: 'Return all employee names in uppercase (as name_upper).',
    difficulty: 'beginner',
  ...
  },
  {
    ...
    description: 'Show task names with priority (as effective_priority), displaying 0 for NULL priorities using COALESCE.',
    difficulty: 'beginner',
  ...
  },
  {
    ...
    description: 'For each department, show: name, employee count (as emp_count), total salary (as total_salary), and average salary (as avg_salary).',
    difficulty: 'intermediate',
    concepts: ['joins', 'aggregation'],
    topic: 'aggregation',
    topicDifficultyLevel: 2,
...
export function getProblemsByTopic(topic: string): SQLProblem[] {
  return sqlProblems.filter(p => p.topic === topic);
}
