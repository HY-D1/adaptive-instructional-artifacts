...
def write_bundle(
    ...
    manifest = ManifestRecord(
        ...
        embedding_backend=diagnostics.embedding_backend,
        embedding_backends=list(diagnostics.embedding_backends),
        embedding_model=diagnostics.embedding_model,
        embedding_dimension=diagnostics.embedding_dimension,
        embedding_bakeoff_version=diagnostics.embedding_bakeoff_version,
        embedding_queryset_version=diagnostics.embedding_queryset_version,
        doc_count=1,
